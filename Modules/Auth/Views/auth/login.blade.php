<div>
    <div class="mx-auto max-w-md">
        ...
        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Welcome back. Enter your credentials to access your archives.
        </p>
        ...
        <form wire:submit="login" class="mt-6 space-y-4">
            ...
            <div class="flex items-center justify-between">
                <label class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                    <input type="checkbox" wire:model="remember" class="rounded border-gray-300 dark:border-gray-600 dark:bg-gray-800">
                    Remember me
                </label>
                <a href="{{ route('password.request') }}" class="text-sm font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
                    Forgot password?
                </a>
            </div>
        ...
        <div class="mt-4">
            <a href="{{ route('google.redirect') }}" class="flex w-full items-center justify-center gap-2 rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800">
        ...
        <p class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <a href="{{ route('register') }}" class="font-medium text-gray-900 hover:underline dark:text-white">
                Register
            </a>
        </p>
    </div>
