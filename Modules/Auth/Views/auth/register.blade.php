<div>
    <div class="mx-auto max-w-md">
        <h1 class="text-2xl font-bold text-[var(--color-foreground)]">@lang('Create an Account')</h1>
        <p class="mt-2 text-sm text-[var(--color-foreground-secondary)]">
            @lang('Start building your personal archive.')
        </p>
        ...
        <form wire:submit="register" class="mt-6 space-y-4">
            ...
            <button type="submit" wire:loading.attr="disabled"
                ...
                <span wire:loading.remove wire:target="register">@lang('Create Account')</span>
                <span wire:loading wire:target="register">@lang('Creating account...')</span>
            </button>
        </form>
