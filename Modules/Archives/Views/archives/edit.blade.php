<div>
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="flex items-center justify-end gap-3">
            <x-core::button variant="secondary" :href="route('archives.show', ['type' => $this->type, 'archive' => $this->archiveId])">
                @lang('Cancel')
            </x-core::button>
            <x-core::button variant="primary" type="submit" loading wire="save">
                <span wire:loading.remove wire:target="save">@lang('Update :type', ['type' => ucfirst($this->type)])</span>
                <span wire:loading wire:target="save">@lang('Updating...')</span>
            </x-core::button>
        </div>
    </form>
</div>
